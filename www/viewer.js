...
var DEFAULT_URL = 'FinalExam_01.pdf';//'compressed.tracemonkey-pldi-09.pdf';
...
var PDFFindBar = (function PDFFindBarClosure() {
  function PDFFindBar(options) {
    ...
    this.findField.addEventListener('change', function() {
      self.dispatchEvent('');
    });
  ...
  PDFPageView.prototype = {
    ...
    updatePosition: function PDFPageView_updatePosition() {
      if (this.textLayer) {
        ...
        //angular.element(document.getElementById('SoundCtrl')).scope().magicMoment();
      }
    },
    ...
    draw: function PDFPageView_draw() {
      ...
      this.renderTask.promise.then(
        function pdfPageRenderCallback() {
          ...
          angular.element(document.getElementById('controllerForAngular')).scope().textLayer = textLayer;
          if (textLayer) {
    ...
    getText: function  PDFPageView_getText()
    {
  ...
  TextLayerBuilder.prototype = {
    ...
    render: function TextLayerBuilder_render(timeout) {
      ...
      if (this.renderTimer) {
        ...
        angular.element(document.getElementById('controllerForAngular')).scope().finishRenderX();
      }
...
var PDFViewerApplication = {
  ...
  zoomRefresh: function pdfViewZoomIn() {
    var newScale = this.pdfViewer.currentScale;
    this.pdfViewer.currentScaleValue = newScale;
  },
  ...
  open: function pdfViewOpen(file, scale, password,
    ...
    var scopeN = angular.element(document.getElementById('controllerForAngular')).scope();
    var loadingProgressX =  scopeN.loaderProg;
    loadingProgressX.show({
      content: 'Loading',
      animation: 'fade-in',
      showBackdrop: true,
      maxWidth: 200,
...
*/
  ...
  /*
  document.getElementById('zoomInPop').addEventListener('click',
    function() {
      PDFViewerApplication.zoomIn();
    });

  document.getElementById('zoomOutPop').addEventListener('click',
    function() {
      PDFViewerApplication.zoomOut();
    });*/
...
/*
  document.getElementById('pageNumber2').addEventListener('click', function() {
    this.select();
  });

  document.getElementById('pageNumber2').addEventListener('change', function() {
    // Handle the user inputting a floating point number.
